...
systemctl stop systemd-journald.service systemd-journald-dev-log.socket systemd-journald.socket systemd-journald-audit.socket
...
# Clean go cache
rm -rf /__w/.cache/go-build

# Clean container directories
rm -rf /var/lib/docker /var/lib/containerd /var/lib/containers
